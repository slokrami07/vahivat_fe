  ...
  return (
    <Component ref={ref} className={className} style={{ display: 'flex', flexWrap: 'wrap', ...style }}>
      {elements.map((segment, index) => {
        ...
        const isHighlighted = highlightWord && segment.includes(highlightWord);

        return (
          <motion.span
            className={`inline-block will-change-[transform,filter,opacity] ${isHighlighted ? highlightClass : ''}`}
